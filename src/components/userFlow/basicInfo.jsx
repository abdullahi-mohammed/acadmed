    ...
    return (
        <div>
            <div className="flex flex-col rounded-[15px] border border-gray-500/[0.1] my-4">
                <p className="font-medium p-4 px-6 border border-transparent border-b-gray-500/[0.1] bg-gray-100 dark:bg-slate-100/[0.04] rounded-t-[15px]">Fullname</p>
                <div className="px-6">
            ...
            <div className="flex flex-col rounded-[15px] border border-gray-500/[0.1] my-4">
                <p className="font-medium p-4 px-6 border border-transparent border-b-gray-500/[0.1] bg-gray-100 dark:bg-slate-100/[0.04] rounded-t-[15px]">Select Gender</p>
                        ...
                        gender.map(item => {
                            return (
                                <div key={item.id} tabIndex="1" className={`relative ${item.title === data?.gender ? "text-purple font-medium" : "hover:text-purple"}`} aria-label={"gender setting changed to "+ data?.gender} onClick={() => setData({...data, gender: item.title})}>
                                    ...
                                    <div className={`w-full bg-gray-100 dark:bg-slate-100/[0.04] dark:bg-slate-200/[0.08] cursor-pointer rounded-full ${data?.gender === item.title ? "border-2 border-purple/[0.5]" : "hover:border hover:border-purple/[0.5]"}`}>
            ...
            <div className="flex flex-col rounded-[15px] border border-gray-500/[0.1] my-4">
                <p className="font-medium p-4 px-6 border border-transparent border-b-gray-500/[0.1] bg-gray-100 dark:bg-slate-100/[0.04] rounded-t-[15px]">Age</p>
