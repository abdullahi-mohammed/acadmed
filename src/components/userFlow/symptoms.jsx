            ...
            <div className="flex  flex-col rounded-[15px] border border-gray-500/[0.1] my-4">
                ...
                <div className="gap-4 px-6 py-6 overflow-x-auto">
                    <div className="flex flex-wrap gap-2">
                        ...
                        <div className="flex justify-center md:w-[36%] w-full p-4 border border-gray-500/[0.2] fill-white stroke-gray-500 rounded-[15px]">
                            <Model active={active} setActive={setActive} />
                        </div>


                        <div className="px-4 md:w-[60%] w-full">
                            <p className="text-center bg-slate-100 rounded p-2 capitalize">{active.replaceAll("_", " ")}</p>
                        ...
                        <p className="text-center bg-slate-100 rounded p-2 mt-4 w-full">Your Symptoms</p>
